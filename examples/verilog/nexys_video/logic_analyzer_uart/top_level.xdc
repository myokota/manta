# This file based on: github.com/alexforencich/verilog-ethernet/example/NexysVideo/fpga/fpga.xdc
...
# UART
set_property -dict {LOC AA19 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports uart_rxd_out]
set_property -dict {LOC V18 IOSTANDARD LVCMOS33} [get_ports uart_txd_in]

set_false_path -to [get_ports {uart_rxd_out}]
set_output_delay 0 [get_ports {uart_rxd_out}]
set_false_path -from [get_ports {uart_txd_in}]
set_input_delay 0 [get_ports {uart_txd_in}]
